...
<section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Game Of The Year</h2>
                    <h3 class="section-subheading text-muted">The Best Game Of This Year From Jan - Dec</h3>
                </div>
                <div class="row">
                @foreach($goty as $game)
                @php
                $best = $data->where('name', '=' , $game->name );
                @endphp
               @if(count($best) < 1)
               <h3 class="section-subheading text-muted text-center">No Data For This Section</h3>
               @endif
